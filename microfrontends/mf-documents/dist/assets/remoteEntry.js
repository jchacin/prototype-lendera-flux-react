const currentImports = {};
      ...
      let moduleMap = {
"./DocumentsStep":()=>{
      dynamicLoadingCss([], false, './DocumentsStep');
      return __federation_import('./__federation_expose_DocumentsStep-kLhzoF_I.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mfDocuments__' + exposeItemName;
