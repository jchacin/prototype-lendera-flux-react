const currentImports = {};
      ...
      let moduleMap = {
"./KycStep":()=>{
      dynamicLoadingCss([], false, './KycStep');
      return __federation_import('./__federation_expose_KycStep-SI0r-JPH.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mfKyc__' + exposeItemName;
