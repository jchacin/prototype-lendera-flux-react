const currentImports = {};
      ...
      let moduleMap = {
"./LoginPanel":()=>{
      dynamicLoadingCss([], false, './LoginPanel');
      return __federation_import('./__federation_expose_LoginPanel-gyGGT_9-.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mfAuth__' + exposeItemName;
