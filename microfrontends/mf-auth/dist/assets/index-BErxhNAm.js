...
import LoginPanel, { j as jsxRuntimeExports } from './__federation_expose_LoginPanel-gyGGT_9-.js';
...
client.createRoot(root).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px", fontFamily: "system-ui, sans-serif", maxWidth: "520px", margin: "0 auto" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "#dbeafe", color: "#1d4ed8", borderRadius: "12px", padding: "12px 16px", marginBottom: "16px", fontSize: "0.85rem" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "mf-auth" }),
      " — modo standalone · En integración, el shell proporciona el CSS y el event bus."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPanel, {})
  ] }) })
);
